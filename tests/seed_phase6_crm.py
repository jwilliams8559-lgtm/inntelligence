...
def main() -> None:
    ...
    guest_specs = [
        ...
        {"first_name":"Caroline","last_name":"Beaumont","email":"caroline.beaumont@example.com",
        ...
        {"first_name":"William","last_name":"Drayton","email":"wdrayton@example.com",
         ...
         "marketing_consent":True,"tags":[]},
        {"first_name":"Elizabeth","last_name":"Hargrove","email":"ehargrove@example.com",
        ...
        {"first_name":"Olivia","last_name":"Rhett","email":"orhett@example.com",
         ...
         "marketing_consent":True,"tags":[]},
        {"first_name":"Thomas","last_name":"Legare","email":"tlegare@example.com",
        ...
        {"first_name":"George","last_name":"Laurens","email":"glaurens@example.com",
         ...
         "marketing_consent":True,"tags":[]},
        {"first_name":"Anne","last_name":"Middleton","email":"amiddleton@example.com",
        ...
        {"first_name":"James","last_name":"Rutledge","email":"jrutledge@example.com",
         "home_city":"Charlotte","home_state":"NC",
         "total_stays":3,"total_nights":9,"total_revenue":3520,
         "preferred_room_type":"Cottage Room","booking_sources":["direct"],
         "last_stay_date":(today - timedelta(days=200)).isoformat(),
         "marketing_consent":True,"tags":["anniversary"]},
        {"first_name":"Sarah","last_name":"Pinckney","email":"spinckney@example.com",
