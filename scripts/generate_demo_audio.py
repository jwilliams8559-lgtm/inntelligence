...
NARRATIONS: list[str] = [
    ...
    # Step 8
    "This is your Guest CRM — the relationship intelligence layer of Inn-telligence. Every guest who has stayed at Bay Street Inn is here. Complete history. Number of stays. Total lifetime revenue. Last visit date. How they booked. Which rooms they prefer. And segment tags Inn-telligence has automatically assigned based on their behavior. Caroline Beaumont from Charleston. Six stays. $7,250 in lifetime revenue. Last visit April 2026. VIP and Local — a high-value repeat guest who lives close enough to visit frequently. Elizabeth Hargrove from Washington DC. Five stays. $6,420. Tagged Anniversary and VIP — Inn-telligence detected that she and her partner stay around the same dates each year. She's celebrating something meaningful. Every time. At the top of the screen — 16 outreach campaigns. Already drafted. Automatically generated for dates where occupancy is projected below target. The right guests... the right timing... the right offer. Queued for your review. One click sends them. For Caroline — a personal reach-out six weeks before Water Festival. Because historical data shows past VIP guests who receive a personal invitation at that lead time convert at about 34 percent. Not a mass email blast. A targeted, timed message to someone who has already demonstrated... she loves your property.",
