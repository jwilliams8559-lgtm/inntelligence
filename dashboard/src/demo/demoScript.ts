...
export const DEMO_STEPS: DemoStep[] = [
  ...
  },
  {
    ...
    spotlightSelector: '[data-tour="festival-alert"], [data-demo="festival-alert"]',
    narration:
      "I built INNtelligence on real Beaufort, South Carolina market data — specifically calibrated for the boutique inn market on the Historic District's Bay Street waterfront. I didn't build this in a vacuum. I spent months studying this market, analyzing what Cuthbert House Inn and Rhett House Inn were charging, understanding how the Water Festival drives demand, and learning what a boutique inn with a restaurant and rooftop bar actually needs from a pricing tool. The result is a platform that understands the boutique inn market from the inside. My background is eleven years in revenue management as a Certified Pricing Professional — I've built pricing systems for major corporations. INNtelligence brings that same enterprise-grade thinking to properties with 5 to 50 rooms, at a price that makes sense for an independent operator. The Water Festival starts in 57 days. Every day you wait is a day your competitors are filling up at rates you could be charging. INNtelligence starts with a 14-day free trial. No credit card. Let's talk.",
    autoAdvance: true,
  },
]
