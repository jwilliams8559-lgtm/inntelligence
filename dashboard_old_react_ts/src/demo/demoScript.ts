...
export const DEMO_STEPS: DemoStep[] = [
  ...
  },
  {
    ...
    narration:
      "Every month, INNtelligence produces this report. The ROI Performance Report. And I want to be specific about why — because it matters. Most software you buy just... does a thing. You pay for it. You use it. At renewal time you kind of remember it seemed helpful but can't quite put a number on it. INNtelligence doesn't work that way. Every month — documentation. Exact numbers. Specific dates, room types, and rate decisions that generated additional revenue. Direct booking savings from guests captured through your website instead of an OTA. Total value delivered — in dollars — compared directly to your subscription cost. This month's report for Bay Street Inn: Engine revenue contribution — $1,244. The documented additional monthly revenue from rate recommendations — a conservative fifteen percent lift on a typical boutique inn. Direct booking savings — $1,240. Commissions you didn't pay because guests booked directly instead of through Booking dot com or Expedia. Subscription cost — $699. Return on subscription — 1.8 TIMES. For every dollar you spent on INNtelligence this month — you got $1.78 back, and that's before direct-booking savings. And every specific win listed right below. July 20th. Water Festival. Waterfront Suite. $378 became $535. $157 per night. Three nights. One room. One event. This is not a testimonial. This is YOUR data. From YOUR property. Documented and dated. Show it to your accountant. Show it to your bank. Show it to anyone who questions whether it's worth it.",
    autoAdvance: true,
  },
  {
