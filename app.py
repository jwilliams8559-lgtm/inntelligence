...
DEMO_NARRATION = {
    "step_00": "My name is Jim Williams. For eleven years I built enterprise pricing systems for one of America's largest companies, using artificial intelligence to optimize hundreds of millions of dollars in revenue. I managed pricing teams, built machine learning models, and learned how data-driven pricing creates a lasting competitive advantage. Then I fell in love with the Lowcountry. With the historic inns, the Spanish moss, the slow tidal rivers, and the idea that independent innkeepers deserve the same pricing intelligence the largest companies use every day. Here is something I want to be clear about from the start. Artificial intelligence is powerful. It sees patterns no human can see, and it works at a speed no team can match. But artificial intelligence alone is not enough. The best revenue decisions happen when machine intelligence meets human judgment. That is the philosophy behind the Inn-telligence platform. The engine studies your market, watches your competitors, forecasts demand, and writes the recommendations. But every recommendation waits for your review and your approval before anything changes. You are always in control. Inn-telligence gives you the intelligence. You make the call. It connects directly to the property management systems you already use: ResNexus, Cloudbeds, ThinkReservations, Guesty, WebRezPro, and Little Hotelier. And it publishes your approved rates to every major channel at once: Booking dot com, Expedia, Airbnb, V R B O, Hotels dot com, Trip dot com, and Agoda. No manual re-entry. No copy and paste. One approval, and your rates are live everywhere your guests are searching. Inn-telligence is available across the United States, Canada, the United Kingdom, Europe, and the Caribbean. When a competing platform closed its doors recently, its customers were given about thirty days to download their data and find something new. I built Inn-telligence so independent innkeepers would always have a home. A tool that pairs the power of artificial intelligence with the judgment of the person who knows their property and their guests better than any algorithm ever could. This is the Inn-telligence platform. Let me show you what it does, every morning, for one historic waterfront inn in the South Carolina Lowcountry. Let me take you through a typical Monday morning for Sarah, the owner of The Bay Street Inn, a nineteen-room waterfront boutique inn with The Parlor at Bay Street restaurant serving dinner nightly, and a rooftop bar that has become one of the most sought-after spots on the waterfront. This is how Sarah starts every week with Inn-telligence.",
    "step_01": "It is a quiet Monday morning at The Bay Street Inn, a nineteen-room inn on the waterfront in the South Carolina Lowcountry. Downstairs, The Parlor is being set for dinner service. Upstairs, the rooftop bar is already one of the most sought-after sunset spots in town. Sarah, the owner, pours her first cup of coffee and picks up her iPad. And that matters, because the Inn-telligence platform is built mobile first. Every feature you are about to see works exactly the same on a phone, a tablet, or a laptop. Sarah runs her entire revenue strategy from the breakfast table, the front porch, or the farmers market, wherever the morning takes her. The days of being chained to a back-office desktop are over. Inn-telligence has been working all night. It watched every lodging property within twenty-five miles, thirty-nine of them, from the grand resorts down to the budget chains. It compared her booking pace to the same week last year. It cross-referenced the local event calendar against five years of occupancy history. And it has something to tell her. The Water Festival begins in fifty-two days, and demand is building fast. Every recommendation is waiting for her review. Nothing has changed yet. Nothing changes until Sarah says so.",
    "step_02": "The Rate Calendar is the heart of the Inn-telligence platform. Ninety days of recommendations, every room, every night, color-coded by opportunity. The selector at the top lets Sarah look at a week, two weeks, a month, or the full quarter. Right now she is seeing the whole quarter, so nothing sneaks up on her. The colors tell the story instantly. Deep navy means a rate increase opportunity, and the richer the color, the stronger the signal. Soft red marks the slower nights, where a small, smart discount keeps rooms full. And those gold columns in mid-July? That is the Water Festival, the busiest stretch of the year, flagged at the very top of the demand scale. But every cell is still just a recommendation. Nothing is live. Nothing publishes until Sarah reviews it and approves. The engine did the analysis. Sarah makes the decision.",
    "step_03": "Sarah taps a Water Festival night on one of her waterfront suites, and the recommendation opens. This is where Inn-telligence shows its work. The recommended rate is a healthy premium over the room's everyday price. But she does not just see a number. She sees exactly how the engine got there, and she can accept it, adjust it, or overrule it with her own knowledge of her inn. The reasoning is laid out in plain language. A peak demand score, driven by the festival. Direct waterfront competitors filling up and posting sold-out nights. And a booking pace running nearly fifty percent ahead of last July. Then the commission math. After a typical fifteen percent channel commission, a direct booking on the inn's own site nets more, and the guest still saves. Everyone wins, and Sarah captures the guest's email for next time. A three-night minimum is suggested for the festival, because a two-night stay would block a more valuable booking. The engine catches that automatically. Sarah reads it, agrees, and approves.",
    "step_04": "Before she approves the full set, Sarah checks Competitive Intelligence. Inn-telligence found thirty-nine lodging properties within twenty-five miles and scored every one of them on five dimensions: price range, amenities, distance, review tier, and size, to surface the nine that truly shape her pricing. Here is what makes this screen different. Sarah is pricing a waterfront suite, so she filters to waterfront. Watch the list. Properties without a true waterfront room gray themselves out. A lovely historic inn with no river view? Gone. The big chains without waterfront suites? Gone. What remains are only the rooms that actually compete with hers, because comparing a waterfront suite to a garden room is comparing apples to oranges, and the engine refuses to do that. Among the real waterfront rivals, the Cuthbert House scores about ninety-three, and the Anchorage scores about eighty-nine. Both are filling fast on festival weekend. One is already sold out, the other nearly there. When the waterfront competition runs out of rooms, The Bay Street Inn becomes the waterfront option in town. That is the compression built into a recommended rate of five hundred and seventy-five dollars. The price ladder makes it obvious. A luxury resort sits far above at eleven hundred. The budget chain anchors the floor near two hundred. And at five seventy-five, The Bay Street Inn is positioned exactly where it should be. Not a guess. A defensible market position.",
    "step_05": "Sarah opens the demand calendar and looks at the year ahead. Every driver the engine tracks, organized so she can plan a week, a month, a quarter, or twelve months out. This Friday brings a graduation at the Marine base nearby, the kind of reliable, every-week demand the engine has already learned to price for. Late spring brings one of the most important cultural festivals in the region. July brings the Water Festival, the peak of the year. Autumn brings the film festival, and then the holidays. Looking across the whole year, Sarah sees every surge plotted against her current pace, with time to prepare for each one. No surprises. No scrambling. The engine keeps the calendar so she never has to.",
    "step_06": "A wedding inquiry just landed. Margaret and Thomas are considering the inn for a September celebration. Forty guests, the whole property, two nights. The old way, Sarah would lose half an hour in a spreadsheet and still second-guess the number. Inn-telligence prices it instantly: the room block, the event space, the food and beverage, setup and breakdown, and the exclusivity premium for turning every other guest away. The package comes to thirty-seven thousand, three hundred dollars, more than twenty thousand above what those rooms would earn sold individually that weekend. A clear yes. But watch what happens when the date moves onto Water Festival weekend. The conflict alert fires immediately, because festival pricing on those nights is worth more than the buyout. The engine flags it and recommends declining or negotiating above festival rates. One date change, thousands of dollars protected, money most innkeepers would never have known to count. The engine raised its hand. Sarah makes the call.",
    "step_07": "Beyond weddings, the Private Events screen handles corporate retreats, family reunions, full buyouts, and group bookings, all with the same intelligence: conflict detection, and an exclusivity calculator so Sarah never under-prices a buyout. The Packages screen is where Inn-telligence really pulls ahead of every other pricing tool. We have built in the twenty-five packages boutique inns reach for most often: romance, anniversary, culinary, birding and nature, spa, and more. Turn one on with a single click, or off just as easily, each pre-priced from market data and tied into the rate calendar, so the engine measures true revenue per available room, not just the nightly rate. The Gift Shop tracks retail right alongside lodging. But what truly sets The Bay Street Inn apart from every competitor in this market is not just the rooms. The Parlor at Bay Street serves dinner nightly to inn guests and locals alike, a full-service restaurant that generates revenue from people who may never spend a night in the inn. And the rooftop bar has become one of the most popular destinations on the waterfront, drawing crowds on weekend evenings and during festival periods from across the region. Inn-telligence tracks every revenue stream: dinner covers per service, average check per table, bar revenue by night, and food and beverage yield during peak occupancy. The rooftop bar alone during Water Festival week generates revenue that rivals a fully occupied room block. This is what Inn-telligence sees that no other pricing tool even looks at: total property revenue, not just nightly rates.",
    "step_08": "Sarah opens the guest list. Every guest, sorted automatically, every night. Seven V I Ps, the regulars and the big spenders. Eight locals who drive in for weekend escapes. Three guests who have not been back in over a year. Four who just discovered the inn. And two with anniversaries coming up, pulled straight from their booking notes. Because the engine is forecasting a soft stretch in November, it has already drafted a win-back email to the lapsed guests, a warm note and a return offer, written in the inn's own voice. Sarah reads it, recognizes one name, adds a personal line, and approves. The platform created the opportunity and wrote the first draft. The human made it personal. That is the combination that actually books rooms. And every guest who joins the inn's wifi is invited to share their email, captured in the moment they are happiest, relaxing by the water. That email becomes a relationship, and that relationship becomes the next booking, with no commission and no acquisition cost.",
    "step_09": "Next, reputation. Inn-telligence pulls reviews from Google, TripAdvisor, and Booking dot com into one feed, scores the sentiment, and flags anything that needs a human reply. The inn holds a four-point-eight across every platform, up from a four-point-six a year ago, the kind of lift that comes from steady pricing, fewer overbookings, and more time spent on guests instead of spreadsheets. One review is flagged this morning. A guest felt check-in ran a little slow on a busy afternoon. The engine drafts a reply, Sarah makes it her own, and posts it in a tap. Reputation is revenue. Moving from a four-point-six to a four-point-eight on the major review sites lifts booking conversion by six to eight percent, and the platform keeps that connection in view, so Sarah can see the dollars behind every five-star stay.",
    "step_10": "Her Professional subscription is six ninety-nine per month. During Water Festival month alone, with twelve rooms averaging a hundred and twenty-five dollar rate lift over thirty nights, the room revenue lift exceeds forty-five thousand dollars. Against a six ninety-nine subscription, that is a sixty-four times return in a single month. Annualized across all revenue streams, including direct booking savings, guest campaigns, packages, gift shop, and food and beverage, the total lift is ninety-three thousand five hundred dollars against an eight thousand three hundred eighty-eight dollar annual subscription. Eleven-point-one times your total investment. Every year.",
    "step_11": "Sarah has spent less than an hour with her coffee, and she has touched every decision that matters. She reviewed the Water Festival recommendations and understood the reason behind each one. She confirmed her position against the waterfront competition and knows her rate will hold. She accepted a September wedding on terms that work. She approved a win-back campaign and made it personal. She answered a flagged review in her own voice. And she watched her revenue per room climb twenty-six percent over last year. Now there is one thing left to do. She taps Approve All. In just over two seconds, the Inn-telligence platform publishes every approved rate to all seven channels at once: Booking dot com, Expedia, Airbnb, V R B O, Hotels dot com, Trip dot com, and Agoda. Every room. Every date in the window. Live, everywhere, instantly. Sarah sets down the iPad and heads downstairs to greet her guests at breakfast. The old way, this was two hours every Monday, done by hand, usually a little wrong, and always leaving money on the table. Now it is under an hour, once a week, with the full reasoning in front of her and her own judgment on every call. The intelligence works all night, so the innkeeper can work smarter in the morning.",
    "closing": "Inn-telligence is built for one kind of place. The independent boutique inn. The historic property. The Select Registry member, where the owner knows every guest by name and the building itself is part of the story. Not the chains. Not the vacation-rental platforms. It pairs real artificial intelligence with real human judgment, because the best revenue decisions happen when powerful data meets the instincts of the innkeeper who lives the property every day. Right now we are choosing three to five founding members for the pilot. Founding members get the full Professional tier, everything in this demonstration, free for six months. In return we ask three things: connect your property management system, join a short monthly feedback call, and share an honest testimonial at ninety days if we have earned it. After the founding period, it is six ninety-nine a month. For a nineteen-room waterfront inn, the conservative numbers come to ninety-three thousand five hundred dollars in added revenue a year, against an eighty-three-hundred-dollar subscription. About eleven times your investment, every year. And it is ready today. If your property management system has an open connection, Inn-telligence links to it in minutes and publishes to all seven major channels with one click. No long integration. No technical team. Connect, approve your first recommendations, and your rates go live everywhere your guests are searching, the same afternoon. My name is Jim Williams. Four-seven-zero, seven-eight-nine, two-four-three-three. Tap the button, and I will personally answer within twenty-four hours.",
}
