...
DEMO_NARRATION = {
    ...
    "step_07": "Beyond weddings, the Private Events screen manages corporate retreats, family reunions, and anniversary celebrations — all with the same revenue intelligence and conflict detection. The Packages screen manages every upsell opportunity at Bay Street Inn. Romance package — champagne, roses, chocolates, candlelit turndown — adds eighty-five dollars per stay with minimal incremental cost. Anniversary package with couples massage voucher and breakfast in bed adds one hundred and twenty dollars. Birding and nature packages for Lowcountry wildlife enthusiasts. Culinary packages showcasing the extraordinary food scene in Byo-fort. Each package integrated with the rate calendar so INNtelligence factors package revenue into total RevPAR calculations. The Gift Shop tracks retail revenue — branded merchandise, local artisan goods, Lowcountry pantry items, Murano glass, works by local artists. Forty to sixty thousand dollars in annual gift shop revenue is realistic for a well-run nineteen-room inn — revenue that most traditional pricing tools completely ignore. And for The Bay Street Inn — The Parlor at Bay Street serves dinner nightly to inn guests and Byo-fort locals, while the rooftop bar has become one of the most sought-after spots in downtown Byo-fort on weekend evenings. INNtelligence tracks F and B yield alongside room revenue — covers per service, average check, bar revenue by night, and how F and B performance correlates with room occupancy. During Water Festival the rooftop bar alone generates significant incremental revenue from festival-goers who may never book a room. INNtelligence helps Sarah understand and optimize every revenue stream the property produces — not just the rooms.",
    "step_08": "Sarah clicks Guest CRM. Every guest automatically segmented every night by INNtelligence. Seven VIP guests — three or more stays or fifteen hundred dollars in lifetime revenue. Eight local guests from South Carolina and Georgia who drive in for weekend escapes. Three lapsed guests who have not returned in over a year. Four new guests from their first stay in the last ninety days. Two anniversary guests identified from booking notes and stay history. Because INNtelligence is forecasting occupancy below fifty-five percent for two weeks in November, it has automatically drafted an email campaign targeting the lapsed guest segment with a special return rate and a personal message. The campaign was written by the AI based on Bay Street Inn's voice and guest history. Sarah reads it. She knows one of the lapsed guests personally and adds a specific handwritten touch. She approves. INNtelligence sends. The AI created the opportunity and wrote the first draft. The human made it personal. That combination is what drives results. Every guest who connects to the wifi at Bay Street Inn is prompted to share their email and consent to future communications — captured at the moment they are most engaged, sitting in a beautiful waterfront inn in Byo-fort, feeling the magic of the Lowcountry. That email becomes a relationship. That relationship becomes a repeat booking with no OTA commission and no acquisition cost.",
