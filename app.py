...
DEMO_NARRATION = {
    ...
    "step_10": "Sarah checks her performance numbers. This month versus last year — occupancy up nine percent, average daily rate up sixteen percent, RevPAR up twenty-six percent. Not accidental. The result of ninety days of INNtelligence recommendations reviewed, validated, and approved consistently. The AI provided the recommendations. Sarah provided the judgment. Together they produced a twenty-six percent RevPAR improvement. Her Professional subscription is six hundred and ninety-nine dollars per month. Average monthly revenue lift from approved recommendations — one thousand two hundred and forty-four dollars, calculated from her actual data versus prior year baseline. Net monthly benefit — five hundred and forty-five dollars every month in her pocket that was not there before. A one-point-eight times return at the conservative fifteen percent lift scenario. At twenty percent the return climbs above two times. For a nineteen-room waterfront inn generating four hundred thousand dollars annually, a fifteen percent lift is sixty thousand dollars in additional revenue. The annual subscription costs eight thousand three hundred and eighty-eight dollars. Annual return on investment — seven-point-one times. Conservative. Auditable. Real.",
    ...
    "closing": "INNtelligence is built exclusively for independent boutique inns and Select Registry properties. Not for hotel chains. Not for vacation rental platforms. For the kind of property where the owner knows every guest by name, where the history of the building is part of the experience, where excellence is deeply personal. INNtelligence combines artificial intelligence with human judgment — because the best revenue decisions are made when powerful data meets the irreplaceable knowledge of the innkeeper who lives and breathes their property every day. We are selecting three to five founding members for our pilot program. Founding members receive the complete Professional tier of INNtelligence — everything you just saw in this demonstration — free for six months. In exchange we ask for three things. Connect your property management system. Participate in monthly feedback calls. And share your honest testimonial after ninety days if the results warrant it. After your founding period — six hundred and ninety-nine dollars per month. For a nineteen-room waterfront inn generating four hundred thousand dollars annually, a fifteen percent revenue lift is sixty thousand additional dollars per year. The subscription costs eight thousand three hundred and eighty-eight per year. The annual return on investment is seven-point-one times. Conservative. Auditable. Real. INNtelligence connects to ResNexus, Cloudbeds, ThinkReservations, Guesty, WebRezPro, and Little Hotelier — and publishes to Booking dot com, Expedia, Airbnb, VRBO, Hotels dot com, Trip dot com, and Agoda. Available across the United States, Canada, the United Kingdom, Europe, and the Caribbean. TakeUp AI closed their doors on May first — twenty-five days ago. Their customers had thirty days notice. INNtelligence is open, it is built, it is live, and it is looking for the right founding partners to shape what comes next in boutique hospitality revenue management. My name is Jim Williams. Four-zero-four, nine-zero-nine, five-eight-one-eight. Click the button and I will personally respond within twenty-four hours.",
}
